...
export const soundsUnits = [ [ './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3',
'./sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3',
'./sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3' ], 
[ './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3',
'./sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3', './sounds/audio_units/error.mp3',
'./sounds/audio_units/error.mp3' ], 
[], [] ];
...
[ [ [ 'Эльфийский Владыка', 200, 60, 40, 0, 0, 0, 1, 'ближняя', 'elfs_captain.png', '1' ],
    ...
    [ 'Часовой', 120, 65, 0, 25, 0, 0, 1, 'дальняя', 'elfs_quard.png', '7' ],
...
{ path: './animation/Empire/mag/mag_damage.gif', size: [ 221, 292 ] } ], 
...
{ path: './animation/Empire/priest/priest_getdam_right.gif', size: [ 115, 114 ] } ] }, 
    ...
    right: { path: './animation/Empire/death_unit_right.gif', size: [ 150, 160 ] } }, 
...
{ left: [ { path: './animation/Demons/demonolog/demonolog_state_left.gif', size: [ 126, 159 ] }, 
{ path: './animation/Demons/demonolog/demonolog_attack_left.gif', size: [ ] }, 
{ path: './animation/Demons/demonolog/demonolog_getdam_left.gif', size: [ 129, 159 ] }, 
{ path: './animation/Demons/demonolog/demonolog_damage.gif', size: [ 298, 256 ] } ], 
right: [ { path: './animation/Demons/demonolog/demonolog_state_right.gif', size: [ 126, 159 ] }, 
{ path: './animation/Demons/demonolog/demonolog_attack_right.gif', size: [ ] }, 
{ path: './animation/Demons/demonolog/demonolog_getdam_right.gif', size: [ 129, 159 ] }, 
{ path: './animation/Demons/demonolog/demonolog_damage.gif', size: [ 298, 256 ] } ] },
...
{ left: [ { path: './animation/Demons/modeus/modeus_state_left.gif', size: [ ] }, 
{ path: './animation/Demons/modeus/modeus_attack_left.gif', size: [ 233, 162 ] }, 
{ path: './animation/Demons/modeus/modeus_getdam_left.gif', size: [ 266, 159 ] }, 
{ path: './animation/Demons/modeus/modeus_damage.gif', size: [ 275, 275 ] } ], 
right: [ { path: './animation/Demons/modeus/modeus_state_right.gif', size: [ ] }, 
{ path: './animation/Demons/modeus/modeus_attack_right.gif', size: [ 233, 162 ] }, 
{ path: './animation/Demons/modeus/modeus_getdam_right.gif', size: [ 266, 159 ] }, 
{ path: './animation/Demons/modeus/modeus_damage.gif', size: [ 275, 275 ] } ] } 
],
    Elfs: [],
    Deads: []
